...
const translations = {
    zh: {
        ...
        tue_title: '建設避難所',
        tue_desc: '提升建築戰力、加速建造與招募避難者獲取積分',
        wed_title: '研究科技',
        ...
        drawing_bonus: '改裝圖紙相關額外加成 (%)',
        wrench_bonus: '黃金扳手相關額外加成 (%)',
        monster_bonus: '擊殺野外生物額外加成 (%)',
        gather_bonus: '資源採集額外加成 (%)',
        unit_1k: '1000 單位',
    ...
    en: {
        ...
        tue_desc: 'Earn points through building power, speedups, and recruiting survivors',
        ...
        drawing_bonus: 'Blueprint related bonus (%)',
        wrench_bonus: 'Wrench related bonus (%)',
        monster_bonus: 'Wild creature bonus (%)',
        gather_bonus: 'Gathering bonus (%)',
        unit_1k: '1000 units',
